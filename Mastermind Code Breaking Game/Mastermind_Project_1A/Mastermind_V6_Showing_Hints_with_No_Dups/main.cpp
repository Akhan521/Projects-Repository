 ...
 * File:   main.cpp
 * Author: Aamir Khan
 * Created on March 22, 2022, 6:00 PM
 * Purpose: Mastermind V.6
 * Showing hints for the guesses we make. For now, the guesses need to be unique.
 * The hints are given for the code to break where NO duplicates are used.
 */
