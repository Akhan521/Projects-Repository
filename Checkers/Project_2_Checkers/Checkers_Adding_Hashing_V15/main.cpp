 ...
 * 
 * Note: Hashing is used to check whether a randomly chosen
 * piece was possibly captured by either player. Given that
 * collisions may occur, our result is probabilistic.
 */
...
int main(int argc, char** argv) {
    ...
    cout<<plyr1->getName()<<"'s pieces are: "<<
         (plyr1->getPiece()==" B "?"Black\n":"Red\n");
    plyr2->setPiece(" R ");  //Player 2 has red as their color.
    cout<<plyr2->getName()<<"'s pieces are: "<<
         (plyr2->getPiece()==" B "?"Black\n":"Red\n");
