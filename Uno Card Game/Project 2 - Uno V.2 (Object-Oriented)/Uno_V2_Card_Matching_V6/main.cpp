 ...
 * File:   main.cpp
 * Author: Aamir Khan
 * Created on May 21, 2021, 6:10 PM
 * Purpose: Matching Multiple Times + Overloaded += Op. For Drawing Cards
 *             + Adding Functions That Test for Draw Cards.
 */
...
int main(int argc, char** argv) {
    ...
    cout<<"Sixth Program of Project 2: "<<endl;
    ...
    do{
        ...
        //If both are draw cards -> match. If the the colors match -> match.
