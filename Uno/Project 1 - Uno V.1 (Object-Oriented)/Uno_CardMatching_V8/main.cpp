 ...
 * File:   main.cpp
 * Author: Aamir 
 * Created on April 15, 2021, 10:30 PM
 * Purpose: Dynamic Structure Array + Array/Pointer Notation
 */
...
int main(int argc, char** argv) {
    ...
    cout<<"Eighth Program of My Uno Project 1."<<endl;
    //Create a dynamic array of structures with twice the size for extra space
    //This space is for when we draw 1/2 cards if we happen to do so.
    UnoCard *plyrDck=new UnoCard[numCrds*2];
