 ...
 * Purpose: Deriving Another Class from the Player Class.
 */
...
int main(int argc, char** argv) {
    ...
    //Declare Variables
    cout<<"Ninth Program of Project 2: "<<endl;
    ...
    //Showing a Simple Use of the Derived Player. 
    cout<<endl<<endl<<"Using our Derived Player:"<<endl;
    Deck deck3(numCrds); //For Our Derived Player
    deck3.setDck();
    DerPlayer tmp("Lehr",45);
    tmp.setDck(&deck3);
    cout<<"Derived Player: "<<tmp.getName()<<endl;
    cout<<"Age: "<<tmp.getAge()<<endl;
    cout<<"Their Deck of Cards: "<<endl;
    tmp.prntDck();
