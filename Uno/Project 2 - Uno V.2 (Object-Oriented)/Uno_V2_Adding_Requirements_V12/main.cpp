 ...
 * Purpose: Adding Some Requirements -> Copy Constructor, Friend Function, ...
 */
...
int main(int argc, char** argv) {
    ...
    //Declare Variables
    cout<<"Twelfth Program of Project 2: "<<endl;
    ...
    deck1.setDck();
    deck2.setDck();
    //Creating another deck we aren't going to use.
    //Using our copy constructor to copy the contents of the deck over.
    Deck deck3=deck1;
    cout<<"The Original Deck:"<<endl;
    deck1.dsply(); //Displaying the Original Deck.
    cout<<endl;
    cout<<"The Copied Deck:"<<endl;
    deck3.dsply(); //Displaying the Copied Deck to See if it Worked.
