 ...
 * Purpose:            Using Templates in our Program 
 *  ~Still Using UnoCards, but if we do derive another Card Object, we'd be
 *              able to use that object in our template.
 */
...
int main(int argc, char** argv) {
    ...
    //Declare Variables
    cout<<"Eleventh Program of Project 2: "<<endl;
    cout<<"How Many Cards Do You Wish To Generate [1-20]? ";
    int numCrds;
    cin>>numCrds;
    //Create our Double Pointer That Represents our Deck.
    Deck<UnoCard> deck1(numCrds); //For Our First Player
    Deck<UnoCard> deck2(numCrds); //For Our Second Player
    ...
    DerPlayer<UnoCard> mark("Mark",45);
    //An Array of Player Objects.
    Player<UnoCard> **plyrs=new Player<UnoCard> *[nPlyrs];
    //The first object is us.
    plyrs[0]=new Player<UnoCard>("Aamir");
    ...
    plyrs[0]->getnCards()==0?cout<<endl<<"Winner: "<<plyrs[0]->getName()
                            :cout<<endl<<"Winner: "<<plyrs[1]->getName();
